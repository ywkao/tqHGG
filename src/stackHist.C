...
void MakeStackHist(const char* histName){
    ...
    TLegend *legend = new TLegend(0.77,0.25,0.85,0.85);
    ...
    latex.DrawLatex(0.10, 0.95, "#bf{CMS} #it{Preliminary}");
    ...
    latex_lumi.DrawLatex(0.75, 0.92, "41.5 fb^{-1} (2017, #sqrt{s} = 13 TeV)");
    //}}}
    //}}}
    //### Draw lower plots{{{ 
    //============================//
