...
int histNbins[totalHistNum]{
    ...
    50,//hist_DiPhoInfo_pt
    40,//hist_DiPhoInfo_eta
    40,//hist_DiPhoInfo_phi
    50,//hist_DiPhoInfo_energy
    ...
    50,//hist_ElecInfo_electron_pt
    40,//hist_ElecInfo_electron_eta
    40,//hist_ElecInfo_electron_phi
    50,//hist_ElecInfo_electron_energy
    20,//hist_ElecInfo_electron_diphoton_deltaR
    50,//hist_MuonInfo_muon_pt
    40,//hist_MuonInfo_muon_eta
    40,//hist_MuonInfo_muon_phi
    50,//hist_MuonInfo_muon_energy
    20,//hist_MuonInfo_muon_diphoton_deltaR
    //------------------------
    10,//hist_jets_size
    10,//hist_num_jets
    50,//hist_JetInfo_jet_pt
    40,//hist_JetInfo_jet_eta
    40,//hist_JetInfo_jet_phi
    50,//hist_JetInfo_jet_energy
    20,//hist_JetInfo_jet_diphoton_deltaR
    //------------------------
    //Define in selection stage
    //------------------------
    50,//hist_lepton_pt
    40,//hist_lepton_eta
    40,//hist_lepton_phi
    50,//hist_lepton_energy
    20,//hist_lepton_diphoton_deltaR
    //------------------------
    20,//hist_jet1_diphoton_deltaR
    20,//hist_jet2_diphoton_deltaR
    20,//hist_jet1_lepton_deltaR
    20,//hist_jet2_lepton_deltaR
    //------------------------
    50,//hist_jet1_pt
    40,//hist_jet1_eta
    40,//hist_jet1_phi
...
double histBinHigh[totalHistNum]{
    100,//hist_EvtInfo_NPu
    1000,//hist_EvtInfo_Rho
    100,//hist_EvtInfo_NVtx
    100,//hist_EvtInfo_genweight
    //------------------------
    100,//hist_DiPhoInfo_mass
    1000,//hist_DiPhoInfo_pt
    2.5,//hist_DiPhoInfo_eta
    3.0,//hist_DiPhoInfo_phi
    1000,//hist_DiPhoInfo_energy
    1000,//hist_DiPhoInfo_leadPt
    2.5,//hist_DiPhoInfo_leadEta
    3.0,//hist_DiPhoInfo_leadPhi
    1000,//hist_DiPhoInfo_leadE
    0.5,//hist_DiPhoInfo_leadhoe
    1.,//hist_DiPhoInfo_leadIDMVA
    1000,//hist_DiPhoInfo_subleadPt
    2.5,//hist_DiPhoInfo_subleadEta
    3.0,//hist_DiPhoInfo_subleadPhi
    1000,//hist_DiPhoInfo_subleadE
    0.5,//hist_DiPhoInfo_subleadhoe
    1.,//hist_DiPhoInfo_subleadIDMVA
    //------------------------
    10,//hist_ElecInfo_Size
    10,//hist_MuonInfo_Size
    ...
    10,//hist_num_electrons// # of selected objects.
    10,//hist_num_muons// # of selected objects.
    1000,//hist_ElecInfo_electron_pt
    2.5,//hist_ElecInfo_electron_eta
    3.0,//hist_ElecInfo_electron_phi
    1000,//hist_ElecInfo_electron_energy
    20,//hist_ElecInfo_electron_diphoton_deltaR
    1000,//hist_MuonInfo_muon_pt
    2.5,//hist_MuonInfo_muon_eta
    3.0,//hist_MuonInfo_muon_phi
    1000,//hist_MuonInfo_muon_energy
    20,//hist_MuonInfo_muon_diphoton_deltaR
    //------------------------
    10,//hist_jets_size
    10,//hist_num_jets
...
/*
    ...
    //------------------------
    TH1D *hist_DiPhoInfo_mass = new TH1D("hist_DiPhoInfo_mass", "", 100, 0, 100);
    TH1D *hist_DiPhoInfo_pt = new TH1D("hist_DiPhoInfo_pt", "", 50, 0, 1000);
    ...
    TH1D *hist_DiPhoInfo_energy = new TH1D("hist_DiPhoInfo_energy", "", 50, 0, 1000);
    TH1D *hist_DiPhoInfo_leadPt = new TH1D("hist_DiPhoInfo_leadPt", "", 50, 0, 1000);
    ...
    TH1D *hist_DiPhoInfo_leadE = new TH1D("hist_DiPhoInfo_leadE", "", 50, 0, 1000);
    TH1D *hist_DiPhoInfo_leadhoe = new TH1D("hist_DiPhoInfo_leadhoe", "", 50, 0, 1.);
    TH1D *hist_DiPhoInfo_leadIDMVA = new TH1D("hist_DiPhoInfo_leadIDMVA", "", 50, -1., 1.);
    TH1D *hist_DiPhoInfo_subleadPt = new TH1D("hist_DiPhoInfo_subleadPt", "", 50, 0, 1000);
    ...
    TH1D *hist_DiPhoInfo_subleadE = new TH1D("hist_DiPhoInfo_subleadE", "", 50, 0, 1000);
    TH1D *hist_DiPhoInfo_subleadhoe = new TH1D("hist_DiPhoInfo_subleadhoe", "", 50, 0, 1.);
    ...
    TH1D *hist_ElecInfo_electron_energy = new TH1D("hist_ElecInfo_electron_energy", "", 50, 0, 1000);
    TH1D *hist_ElecInfo_electron_diphoton_deltaR = new TH1D("hist_ElecInfo_electron_diphoton_deltaR", "", 100, 0, 100);
    ...
    TH1D *hist_MuonInfo_muon_energy = new TH1D("hist_MuonInfo_muon_energy", "", 50, 0, 1000);
    TH1D *hist_MuonInfo_muon_diphoton_deltaR = new TH1D("hist_MuonInfo_muon_diphoton_deltaR", "", 100, 0, 100);
    //------------------------
    ...
    TH1D *hist_JetInfo_jet_energy = new TH1D("hist_JetInfo_jet_energy", "", 50, 0, 1000);
    TH1D *hist_JetInfo_jet_diphoton_deltaR = new TH1D("hist_JetInfo_jet_diphoton_deltaR", "", 100, 0, 100);
    //------------------------
    //Define in selection stage
    //------------------------
    ...
    TH1D *hist_lepton_energy = new TH1D("hist_lepton_energy", "", 50, 0, 1000);
    TH1D *hist_lepton_diphoton_deltaR = new TH1D("hist_lepton_diphoton_deltaR", "", 100, 0, 100);
    //------------------------
    TH1D *hist_jet1_diphoton_deltaR = new TH1D("hist_jet1_diphoton_deltaR", "", 100, 0, 100);
    TH1D *hist_jet2_diphoton_deltaR = new TH1D("hist_jet2_diphoton_deltaR", "", 100, 0, 100);
    TH1D *hist_jet1_lepton_deltaR = new TH1D("hist_jet1_lepton_deltaR", "", 100, 0, 100);
    TH1D *hist_jet2_lepton_deltaR = new TH1D("hist_jet2_lepton_deltaR", "", 100, 0, 100);
    //------------------------
    ...
    TH1D *hist_jet1_energy = new TH1D("hist_jet1_energy", "", 50, 0, 1000);
    ...
    TH1D *hist_jet2_energy = new TH1D("hist_jet2_energy", "", 50, 0, 1000);
    //------------------------
    ...
    TH1D  *hist_leading_bjet_energy = new TH1D("hist_leading_bjet_energy", "hist_leading_bjet_energy", 50, 0, 1000);
    ...
    TH1D  *hist_chosen_bjet_energy = new TH1D("hist_chosen_bjet_energy", "hist_chosen_bjet_energy", 50, 0, 1000);
    //------------------------
